...
L["ELLESMERE_APPLY_ALL_DESC"] = "Copy this frame's icon settings, including its enabled state, style, size and position, to all five supported EllesmereUI frames."
